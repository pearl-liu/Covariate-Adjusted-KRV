...
DM_parameter_est = readRDS("data/throat.otu.tab.DM.parameter.estimates.rds")

# simulated SNP data over 1Mb using cosi2 program
eur_afr_haplo_mt = readRDS("data/10000eur_10000afr_1Mb_haplotype_matrix.rds")
eur_afr_haplo_snp_pos = readRDS("data/10000eur_10000afr_1Mb_haplotype_SNP_position.rds")
eur_afr_haplo_maf = readRDS("data/10000eur_10000afr_1Mb_haplotype_SNP_MAF.rds")

# labels of OTUs belonging to a common phylogenetic cluster
com_cluster = readRDS('data/throat_OTU_labels_node1148.rds')
