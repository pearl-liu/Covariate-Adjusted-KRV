...
Rscript code/microbiome_GWAS_simulation.R  --n=150  --n_sim=600 --n_pop=2 --seed_num=123 --power=0  --power_situation=0 --output_file='example_type_I_error_simulation_result.csv' 
```

### Simulation to evaluate power of adjusted KRV and competing methods (Figure 4)
```{r, engine = 'bash', eval = FALSE}
Rscript code/microbiome_GWAS_simulation.R  --n=150  --n_sim=300 --n_pop=2 --seed_num=123 --power=1  --power_situation=1 --output_file='example_power_situation1_simulation_result.csv' 

Rscript code/microbiome_GWAS_simulation.R  --n=150  --n_sim=300 --n_pop=2 --seed_num=123 --power=1  --power_situation=2 --output_file='example_power_situation2_simulation_result.csv' 

Rscript code/microbiome_GWAS_simulation.R  --n=150  --n_sim=300 --n_pop=2 --seed_num=123 --power=1  --power_situation=3 --output_file='example_power_situation3_simulation_result.csv' 
